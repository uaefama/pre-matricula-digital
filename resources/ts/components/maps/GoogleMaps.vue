<template>
  <div class="google-map" role="application" aria-label="Mapa interativo do Google Maps">
    <span class="visually-hidden">
      Mapa interativo fornecido pelo Google Maps. Use as setas do teclado para navegar pelo mapa.
    </span>
